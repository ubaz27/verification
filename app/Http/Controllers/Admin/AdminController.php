...
class AdminController extends Controller
{
    ...
    public function showAdmins()
    {
        ...
        return view('admin.admin.admin-page', compact('users', 'positions'));
    }
    ...
    public function editAdmin(Request $request)
    {
        ...
        $positions = Position::where('id', '>',  1)->get();
        $users = Admin::join('positions', 'admins.position_id', 'positions.id')
        ...
        // dd($users);
        return view('admin.admin.edit-admin', compact('users', 'positions'));
    }
