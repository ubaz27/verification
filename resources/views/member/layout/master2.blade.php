        ...
        <header class="fixed top-0 left-0 right-0 bg-white shadow-sm z-50">
            <div class="container mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ url('/job-adverts') }}"
                        class="nav-link text-gray-800 font-medium hover:text-primary transition">Jobs</a>
                    <a href="{{ url('/scholarships') }}"
                        class="nav-link text-gray-800 font-medium hover:text-primary transition">Scholarships</a>
                    <a href="{{ url('/about') }}"
            ...
            <div class="md:hidden hidden bg-white shadow-lg absolute top-full left-0 right-0 p-4 border-t"
                ...
                <nav class="flex flex-col space-y-4">
                    ...
                    <a href="{{ url('/job-adverts') }}"
                        class="text-gray-800 font-medium hover:text-primary transition py-2 border-b border-gray-100">Jobs</a>
                    <a href="{{ url('/scholarships') }}"
                        class="nav-link text-gray-800 font-medium hover:text-primary transition">Scholarships</a>
                    <a href="{{ url('/about') }}"
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ url('/portal') }}"
                            class="bg-primary text-white px-5 py-2 !rounded-button font-medium hover:bg-opacity-90 transition text-center mt-2 whitespace-nowrap"><i
                                class="ri-user-line ri-lg"></i>Portal</a>
                    </div>
                </nav>
                {{-- <ul>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start gap-3">
                                ...
                                <span>Alumni Relations Office<br>Bayero University Kano<br>PMB 3011, Kano,
                                    Nigeria</span>
                            </li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li><a href="#" class="hover:text-primary transition">Scholarship Opportunities</a>
                            </li>
                            <li><a href="#" class="hover:text-primary transition">Transcript Requests</a></li>
                            <li><a href="#" class="hover:text-primary transition">University Library Access</a>
                            </li>
