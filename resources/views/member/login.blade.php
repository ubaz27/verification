            ...
            <div class="col-md-8 col-xl-6 mx-auto">
                ...
                <main class="flex-grow container mx-auto px-4 py-12 flex flex-col items-center">
                    ...
                    <section class="login-container bg-white rounded-lg shadow-md p-8 mb-12 w-full">
                        <form id="login-form" class="space-y-6" action="{{ route('member.login') }}" method="POST">
                            <div>
                    ...
                    <section class="container mx-auto px-4 mb-12 text-center">
                        ...
                        <div class="testimonial max-w-2xl mx-auto">
                            <img src="{{ asset('img/alumni-testimonial.jpg') }}" alt="Alumni Testimonial"
                                class="w-24 h-24 rounded-full mx-auto mb-4">
                            <p class="text-gray-600 italic mb-4">"The alumni portal made it so easy to stay connected with
                                my BUK community and access exclusive opportunities."</p>
