...
@section('content')
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Department Page</h4>
                <hr>

                <form id="faculty_form" action="{{ route('admin.saveBatchDepartment') }}" method="POST">
                    @csrf
                    <div class="row">

                        <div class="col-md-6 ">
                            <label for="name" class="form-label">Departments Name</label> (<span
                                class="text-danger">required</span>)

                            <textarea class="form-control" name="departments" id="" cols="30" rows="10" required></textarea>
