...
@section('content')
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Report By Category</h4>
                <hr>

                <form id="report_form" action = "{{ route('admin.pdfRecordByCatetogry') }}" Method = "POST" target="_blank">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <label for="ageSelect" class="form-label">Record Category</label> <span
