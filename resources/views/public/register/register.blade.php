    ...
    <section id="registration" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded shadow-lg p-8 max-w-3xl mx-auto">
                ...
                <span class="text-2xl text-primary text-center font-bold text-gray-800 mb-6">Confirm the data and
                    submit</span>
                <br>
                <br>
                <form id="register" method="POST" name="register" action="{{ url('/save/register') }}">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" id="regno" readonly name="regno" value="{{ $regno }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="firstName" readonly name="first_name" value="{{ $first_name }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded focus:border-primary" required>
                        </div>
                        <div>
                            <label for="firstName" class="block text-gray-700 font-medium mb-2">Middle Name</label>
                            <input type="text" id="middle_name" readonly name="middle_name"
                                value="{{ $middle_name }}"
                        ...
                        <div>
                            <label for="lastName" class="block text-gray-700 font-medium mb-2">Last Name <span
                                    class="text-red">*</span></label>
                            <input type="text" id="lastName" readonly name="last_name"
                                value="{{ $last_name }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded focus:border-primary" required>
                        </div>
                        ...
                        <div>
                            <label for="graduationYear" class="block text-gray-700 font-medium mb-2">Graduation
                                Year </label>
                            <input type="Month" id="graduationYear" name="graduationYear" min="1960"
                                max="2025" value="{{ $year_graduation }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded focus:border-primary">
                        </div>
                        ...
                        <div>
                            <label for="faculty" class="block text-gray-700 font-medium mb-2">Programme <span
                                    class="text-red">*</span></label>
                            <div class="relative">
                                <select id="programme" name="programme_id"
