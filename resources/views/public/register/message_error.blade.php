    ...
    <section id="registration" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded text-center shadow-lg p-8 max-w-3xl mx-auto">
                <h3 class="text-2xl text-center text-red-500 font-bold text-gray-800 mb-6">Registration Form Error</h3>
                {{ $message }}

                <p>
                    Submit your record for verification and upload via <a class="hover:text-primary transition"
                        href="{{ url('/submit-data/submit') }}">here</a>
                </p>
                <br>
                <div class="text-center mb-12">
