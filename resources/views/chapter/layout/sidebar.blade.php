<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item nav-category">Chapter Data</li>

            <li class="nav-item {{ active_class(['apps/chat']) }}">
                <a href="{{ url('/member/apply-publication') }}" class="nav-link">
                    <i class="link-icon" data-lucide="user"></i>
                    <span class="link-title">Search Member</span>
                </a>
            </li>
            <li class="nav-item {{ active_class(['apps/calendar']) }}">
                <a href="{{ url('/member/upload/show') }}" class="nav-link">
                    <i class="link-icon" data-lucide="file"></i>
