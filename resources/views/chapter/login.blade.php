@extends('chapter.layout.master2')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 ps-md-0">
                            <div class="auth-form-wrapper px-4 py-5">
                                ...
                                <form class="forms-sample" action="{{ route('chapter.login') }}" method="POST">
                                    <div class="mb-3">
                                    ...
                                    <div class="form-check mb-3">
                                        ...
                                        <label for=''><a class='btn btn-primary btn-sm'
                                                href='/member/show-register'>Register
                                                here</a></label>
                                    </div>
                                    <div>
